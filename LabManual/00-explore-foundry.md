...
1. まだ有効になっていない場合は、ページ上部のツール バーで **新しい Foundry** オプションを有効にします。プロンプトが表示されたら **新しいプロジェクトの作成** ダイアログが開きます。**詳細オプション** エリアを展開して、プロジェクトの設定を確認します。
