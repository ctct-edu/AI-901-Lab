...
1. モデルのドロップダウン リストで、**gpt-4.1-mini** モデルがデプロイされエージェントに選択されていることを確認します。
...
1. 左側のペインで、モデル選択リストの下にある **音声モード** を有効にします。
...
1. アプリのステータスが **Listening…** になったら、「**音声認識はどのように機能しますか？**」と言って応答を待ちます。
